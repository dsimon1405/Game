...
int main(int argv, char** args)
{
    ...
    // G_PS_Star st(100, {2,2,2}, 1, 10.f, {1, 0, 2});
    // st.SetDrawState(true);
// float width = 800;
// float height = 600;
// ZC_Camera c({0,0,-5}, {0,0.1,0}, {0,0,1}, ZC_Perspective(45.f, static_cast<float>(width) / static_cast<float>(height), 0.01f, 1000.f),
//         ZC_Ortho(0.f, static_cast<float>(width), 0.f, static_cast<float>(height)), true);
// G_PS_Wind w(1, {2,0,0}, 1, 1, {-1,0,0}, 3);
//  w.SetDrawState(true);
